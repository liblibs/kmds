Operation =1
Option =0
Where ="(((SalesGroup.Description)=\"Liquor\") And ((InvoLine.TransType)=\"S\" Or (InvoL"
    "ine.TransType)=\"C\" Or (InvoLine.TransType)=\"D\") And ((InvoLine.SetupDate) Be"
    "tween Forms!PrintInventoryReport!txtDateRangeFrom And Forms!PrintInventoryReport"
    "!txtDateRangeTo))"
Begin InputTables

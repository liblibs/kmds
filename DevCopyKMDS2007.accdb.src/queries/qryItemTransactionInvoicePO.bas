Operation =1
Option =0
Where ="(((InvoLine.InvoHeadID)=Forms!ItemTransactionsByMonthPO!InvoHeadID) And ((InvoLi"
    "ne.CashSysID)=Forms!ItemTransactionsByMonthPO!CashSysID))"
Begin InputTables
    Name ="InvoLine"
    Name ="Item"
    Name ="Cashier"
...
Begin OutputColumns
    ...
    Alias ="Qty"
    Expression ="IIf([TransType]=\"S\" Or [TransType]=\"C\",[Quantity],0)"
    Alias ="UPrice"

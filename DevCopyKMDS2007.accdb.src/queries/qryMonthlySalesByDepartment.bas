...
Where ="(((SalesDepartment.ID) Between Forms!PrintInventoryReport!cboSalesDepartmentIDBe"
    ...
    "0) And ((SalesDepartment.IncludeInInventoryValueReports)<>0) And ((ItemMovement."
    "Description) Like \"*SALES -- TOTAL\") And ((IIf(Forms!PrintInventoryReport!chkP"
    "rintZeroOnhands,-1,0))=0)) Or (((SalesDepartment.ID) Between Forms!PrintInventor"
    "yReport!cboSalesDepartmentIDBegin And Forms!PrintInventoryReport!cboSalesDepartm"
    "entIDEnd) And ((SalesDepartment.IncludeInInventoryValueReports)<>0) And ((ItemMo"
    "vement.Description) Like \"*SALES -- TOTAL\") And ((IIf(Forms!PrintInventoryRepo"
    "rt!chkPrintZeroOnhands,-1,0))=-1))"
Begin InputTables
    Name ="SalesGroup"

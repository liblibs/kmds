...
Where ="(((SalesDepartment.ID) Between Forms!PrintInventoryReport!cboSalesDepartmentIDBe"
    ...
    "ncludeInInventoryValueReports)<>0) And ((ItemMovement.Description)=\"  Sales -- "
    "Total\") And ((IIf(Forms!PrintInventoryReport!chkPrintZeroOnhands,-1,0))=0)) Or "
    "(((SalesDepartment.ID) Between Forms!PrintInventoryReport!cboSalesDepartmentIDBe"
    "gin And Forms!PrintInventoryReport!cboSalesDepartmentIDEnd) And ((SubCategory.De"
    "scription) Between Forms!PrintInventoryReport!cboCategoryIDBegin And Forms!Print"
    "InventoryReport!cboCategoryIDEnd) And ((SalesDepartment.IncludeInInventoryValueR"
    "eports)<>0) And ((ItemMovement.Description)=\"  Sales -- Total\") And ((IIf(Form"
    "s!PrintInventoryReport!chkPrintZeroOnhands,-1,0))=-1))"
Begin InputTables
    Name ="SalesGroup"
...
Begin OutputColumns
    ...
    Alias ="Total"
    Expression ="ItemMovement.YTDQty"
End
Begin Joins
    LeftTable ="Item"
    ...
    Expression ="Item.ID = ItemMovement.Code"
    Flag =1
End
Begin OrderBy
    Expression ="SalesGroup.ID"

Operation =1
Option =0
Having ="(((Format([Code],\"00000000000\")) Between 99900000000 And 99999999999) AND ((Fo"
    "rmat(Sum([quantity]),\"00000;-0000\"))<>0) AND ((InvoLine5.TransType)=\"S\" Or ("
...
Begin OutputColumns
    ...
    Alias ="OLCCItemCode"
    Expression ="Format([Code],\"00000000000\")"
    Alias ="OLCCQuantity"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="qryCreateTransmitDailySalesInvoiceNo.Discount"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="qryCreateTransmitDailySalesTenderCode.TenderCode"
        dbLong "AggregateType" ="-1"
    End
End
Begin

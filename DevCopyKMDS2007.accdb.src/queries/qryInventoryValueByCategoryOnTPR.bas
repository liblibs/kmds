...
Where ="(((SalesDepartment.ID) Between Forms!PrintInventoryReport!cboSalesDepartmentIDBe"
    ...
    "0) And ((SalesDepartment.IncludeInInventoryValueReports)<>0) And ((Item.TPR)<>0)"
    " And ((IIf(Forms!PrintInventoryReport!chkPrintZeroOnhands,-1,0))=0)) Or (((Sales"
    "Department.ID) Between Forms!PrintInventoryReport!cboSalesDepartmentIDBegin And "
    "Forms!PrintInventoryReport!cboSalesDepartmentIDEnd) And ((SalesDepartment.Includ"
    "eInInventoryValueReports)<>0) And ((Item.TPR)<>0) And ((IIf(Forms!PrintInventory"
    "Report!chkPrintZeroOnhands,-1,0))=-1))"
Begin InputTables
    Name ="SalesGroup"

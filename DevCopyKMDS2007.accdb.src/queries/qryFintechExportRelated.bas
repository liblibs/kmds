Operation =1
Option =0
Where ="(((Item.SalesDepartmentID)>2) AND ((InvoLine5.TransType)=\"C\" Or (InvoLine5.Tra"
    "nsType)=\"D\"))"
Begin InputTables
    ...
    Name ="Sysfile"
    Name ="Item"
    Name ="qryFintechDivisionIDRelated"
End
Begin OutputColumns
    Expression ="qryFintechDivisionIDRelated.Division_ID"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="qryFintechDivisionIDRelated.Division_ID"
        dbLong "AggregateType" ="-1"
    End
End
Begin

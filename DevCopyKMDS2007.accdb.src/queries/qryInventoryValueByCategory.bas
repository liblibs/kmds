...
Where ="(((SalesDepartment.ID) Between Forms!PrintInventoryReport!cboSalesDepartmentIDBe"
    "gin And Forms!PrintInventoryReport!cboSalesDepartmentIDEnd) And ((SubCategory.De"
    "scription) Between Forms!PrintInventoryReport!cboCategoryIDBegin And Forms!Print"
    "InventoryReport!cboCategoryIDEnd) And ((Item.Onhand)<>0) And ((SalesDepartment.I"
    "ncludeInInventoryValueReports)<>0) And ((IIf(Forms!PrintInventoryReport!chkPrint"
    "ZeroOnhands,-1,0))=0)) Or (((SalesDepartment.ID) Between Forms!PrintInventoryRep"
    "ort!cboSalesDepartmentIDBegin And Forms!PrintInventoryReport!cboSalesDepartmentI"
    "DEnd) And ((SubCategory.Description) Between Forms!PrintInventoryReport!cboCateg"
    "oryIDBegin And Forms!PrintInventoryReport!cboCategoryIDEnd) And ((SalesDepartmen"
    "t.IncludeInInventoryValueReports)<>0) And ((IIf(Forms!PrintInventoryReport!chkPr"
    "intZeroOnhands,-1,0))=-1))"
Begin InputTables
    Name ="SalesGroup"

...
Where ="(((SalesDepartment.ID) Between Forms!PrintInventoryReport!cboSalesDepartmentIDBe"
    "gin And Forms!PrintInventoryReport!cboSalesDepartmentIDEnd) And ((SalesDepartmen"
    "t.IncludeInInventoryValueReports)<>0) And (([SoldTodayCr5]+[SoldTodayCr4]+[SoldT"
    "odayCr3]+[SoldTodayCr2]+[SoldTodayCr1])<>0)) Or (((SalesDepartment.ID) Between F"
    "orms!PrintInventoryReport!cboSalesDepartmentIDBegin And Forms!PrintInventoryRepo"
    "rt!cboSalesDepartmentIDEnd) And ((SalesDepartment.IncludeInInventoryValueReports"
    ")<>0) And (([SoldTodayCr5]+[SoldTodayCr4]+[SoldTodayCr3]+[SoldTodayCr2]+[SoldTod"
    "ayCr1])<>0))"
Begin InputTables
    Name ="SalesGroup"
...
Begin OutputColumns
    ...
    Alias ="SoldToday"
    Expression ="[SoldTodayCr5]+[SoldTodayCr4]+[SoldTodayCr3]+[SoldTodayCr2]+[SoldTodayCr1]"
End
Begin Joins
    LeftTable ="Item"

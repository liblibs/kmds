...
End
Begin OutputColumns
    Name ="DaysSupplyADSForNewItems.SumOfQuantity"
    Expression ="DaysSupplyADSForNewItems.sumofquantity+((qryDaysSupplyInvoLineItemSalesByMinMaxD"
        "ate.SumOfQuantity/IIf(qryDaysSupplyInvoLineItemSalesByMinMaxDate.Days<30,30,qryD"
        "aysSupplyInvoLineItemSalesByMinMaxDate.days))/[UnitsPerPack])"
End
Begin Joins
    LeftTable ="Item"
    RightTable ="UPCItem"
    ...
    Flag =1
    LeftTable ="DaysSupplyADSForNewItems"
    RightTable ="qryDaysSupplyInvoLineItemSalesByMinMaxDate"
    Expression ="DaysSupplyADSForNewItems.Code = qryDaysSupplyInvoLineItemSalesByMinMaxDate.Code"
    Flag =1
End

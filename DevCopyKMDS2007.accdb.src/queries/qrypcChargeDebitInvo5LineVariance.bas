dbMemo "SQL" ="SELECT qryInvoline5Charges.Auth, qryInvoline5Charges.InvoHeadID, qryInvoline5Cha"
    ...
    "cChargeDebit.Amount, [Price]-[Amount] AS Diff, pcChargeDebit.TroutD\015\012FROM "
    "qryInvoline5Charges INNER JOIN pcChargeDebit ON qryInvoline5Charges.Auth=pcCharg"
    "eDebit.Auth\015\012WHERE ((([Price]-[Amount])<>0));\015\012"
dbMemo "Connect" =""

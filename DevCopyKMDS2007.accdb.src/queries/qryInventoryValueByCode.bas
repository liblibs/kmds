...
Where ="(((SalesDepartment.ID) Between Forms!PrintInventoryReport!cboSalesDepartmentIDBe"
    ...
    "0) And ((SalesDepartment.IncludeInInventoryValueReports)<>0) And ((IIf(Forms!Pri"
    "ntInventoryReport!chkPrintZeroOnhands,-1,0))=0)) Or (((SalesDepartment.ID) Betwe"
    "en Forms!PrintInventoryReport!cboSalesDepartmentIDBegin And Forms!PrintInventory"
    "Report!cboSalesDepartmentIDEnd) And ((SalesDepartment.IncludeInInventoryValueRep"
    "orts)<>0) And ((IIf(Forms!PrintInventoryReport!chkPrintZeroOnhands,-1,0))=-1))"
Begin InputTables
    Name ="SalesGroup"

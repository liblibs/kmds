...
Option =0
Having ="(((First(0-[NonLiquorDiscount]))<>0))"
Begin InputTables
    Name ="qryClubInvoice"
    Name ="Sysfile"
End
Begin OutputColumns
    ...
    Alias ="FirstOfNonClubDiscntItemID"
    Name ="ItemID"
    Expression ="First(Sysfile.NonClubDiscntItemID)"
    Alias ="des"
    Name ="Description"
    Expression ="First(\"Non-LiquorDiscount\")"
    Alias ="Size"
    Name ="Size"
    Expression ="First(\"NLiqDisc\")"
    Alias ="Quantity"
    Name ="Quantity"
    Expression ="First(1)"
    Alias ="Price"
    Name ="Price"
    Expression ="First(0-[NonLiquorDiscount])"
    Alias ="XPrice"
    Name ="XPrice"
    Expression ="First(0-[NonLiquorDiscount])"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="FirstOfNonClubDiscntItemID"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="XPrice"

Operation =1
Option =0
Where ="(((InvoLine5.TransType)<>'X') AND ((InvoLine5.InputCode)<>\"Cash\" And (InvoLine"
    "5.InputCode)<>\"Change\" And (InvoLine5.InputCode)<>\"Checks\" And (InvoLine5.In"
    "putCode)<>\"Visa MC\" And (InvoLine5.InputCode) Not Like \"Auth:*\") AND ((InvoL"
    "ine5.Price)<>0))"
Begin InputTables
    Name ="SalesGroup"

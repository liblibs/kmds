...
Where ="(((InvoLine.SetupDate) Between Forms!PrintInventoryReport!txtDateRangeFrom And F"
    "orms!PrintInventoryReport!txtDateRangeTo) And ((Item.VendorID) Between Forms!Pri"
    "ntInventoryReport!cboVendorIDBegin And Forms!PrintInventoryReport!cboVendorIDEnd"
    "))"

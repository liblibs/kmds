...
Where ="(((InvoLine.TransType)=\"S\" Or (InvoLine.TransType)=\"C\" Or (InvoLine.TransTyp"
    ...
    "ngeFrom And Forms!PrintInventoryReport!txtDateRangeTo) And ((Item.SalesDepartmen"
    "tID) Between Forms!PrintInventoryReport!cboSalesDepartmentIDBegin And Forms!Prin"
    "tInventoryReport!cboSalesDepartmentIDEnd))"
Begin InputTables
...
Begin OutputColumns
    Alias ="Year"
    Expression ="Format([InvoLine].[SetupDate],\"yy\")"
    Alias ="Week"

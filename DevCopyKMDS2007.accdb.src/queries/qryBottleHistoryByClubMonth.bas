...
Begin
    ...
    End
    Begin
        dbText "Name" ="ClubHistoryByBottleByMonth.ClubID"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="ClubHistoryByBottleByMonth.CatDesc"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="ClubHistoryByBottleByMonth.Code"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="ClubHistoryByBottleByMonth.Description"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="ClubHistoryByBottleByMonth.SizeD"
        dbLong "AggregateType" ="-1"
    End
End
Begin

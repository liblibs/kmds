Operation =1
Option =0
Where ="(((InvoLine.Code)=Forms!Item!PurchaseOrdersOnFileSubItemMovement.Form!Code) And "
    "((TranTypes.Description)=Forms!Item!PurchaseOrdersOnFileSubItemMovement.Form!Tra"
    "nsType) And ((InvoLine.SetupDate) Between CDate(Forms!Item!PurchaseOrdersOnFileS"
    "ubItemMovement.Form!txtDateBegin) And CDate(Forms!Item!PurchaseOrdersOnFileSubIt"
    "emMovement.Form!txtDateEnd)))"
Begin InputTables
    Name ="InvoLine"
    Name ="TranTypes"
    Name ="Cashier"

...
Begin Report
    ...
    RecSrcDt = Begin
        0xdecad723102ee540
    End
    RecordSource ="qryInventoryValueByCategory75"
    Caption ="75 Inventory by Last Sold Date"
        ...
        Begin FormHeader
            ...
            Begin
                Begin Label
                    ...
                    FontSize =20
                    Name ="Label47"
                    Caption ="Inventory by Last Sold Date"
                    LayoutCachedLeft =60
                    LayoutCachedTop =60
...
End
CodeBehindForm
' See "75 Inventory By Last Sold Date.cls"

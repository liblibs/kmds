...
Begin Report
    ...
    RecSrcDt = Begin
        0x71d922d60a7de540
    End
    RecordSource ="qry76LiquorItemsNotScanned"
    Caption ="76LiquorItemsNotScanned"
        ...
        Begin FormHeader
            ...
            Begin
                Begin Label
                    ...
                    FontSize =20
                    Name ="Label28"
                    Caption =" Liquor Items Not Scanned"
                    LayoutCachedLeft =-30
                    LayoutCachedTop =60
                ...
                Begin TextBox
                    ...
                    ForeColor =8388608
                    Name ="Text84"
                    ControlSource ="=\"Between \" & Format([Forms]![PrintInventoryReport]![txtDateRangeFrom],\"mm/dd"
                        "/yyyy\") & \" And \" & Format([Forms]![PrintInventoryReport]![txtDateRangeTo],\""
                        "mm/dd/yyyy\")"
                    Format ="Long Date"
                    FontName ="Times New Roman"
...
End
CodeBehindForm
' See "76 Liquor Items Not Scanned.cls"

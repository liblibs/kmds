...
Begin Report
    ...
    OrderBy ="ClubName,Code"
    RecSrcDt = Begin
        0x52e17fdc0f44e340
    End
    RecordSource ="qryClubHistoryByBottleByMonth"
        ...
        Begin FormHeader
            ...
            Begin
                Begin Label
                    ...
                    FontSize =20
                    Name ="Label70"
                    Caption ="Club Purchase History By Code By Month"
                End
                Begin Line
                    BorderWidth =2
                    Top =60
        ...
        Begin BreakFooter
            ...
            Begin
                Begin TextBox
                    ...
                    Width =14280
                    Name ="Text32"
                    ControlSource ="=\"Summary for \" & [ClubName] & \" (\" & Count(*) & \" \" & IIf(Count(*)=1,\"de"
                        "tail record\",\"detail records\") & \")\""
...
End
CodeBehindForm
' See "24 Club History By Bottle By Month.cls"

...
Begin Report
    ...
    RecSrcDt = Begin
        0x9d32c11cb342e340
    End
    RecordSource ="qryPurchaseOrderAndSysfileForVendorScr"
        ...
        Begin PageHeader
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    TabIndex =13
                    Name ="txtPostDate"
                    ControlSource ="qryItemTransactionInvoiceForVendors.SetupDate"
                    Format ="Medium Date"
...
End
CodeBehindForm
' See "PurchaseOrderWithPriceAndCostVendorScr.cls"

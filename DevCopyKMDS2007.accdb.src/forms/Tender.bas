        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT Tender.ID, Tender.Description FROM Tender ORDER BY Tender.ID; "

...
Begin Form
    ...
    Bottom =1230
    Filter ="[ID]=16"
    OrderBy ="SalesDepartment.SalesGroupID, SalesDepartment.ID"
    RecSrcDt = Begin
        0xb5fee5fc7644e340
    End
    RecordSource ="SalesDepartment"
    Caption ="SalesDepartmentGroupID"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    TabIndex =2
                    Name ="Combo6"
                    ControlSource ="SalesGroupID"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT [SalesGroup].[ID], [SalesGroup].[Description] FROM SalesGroup ORDER BY [D"
                        "escription]; "
                    ColumnWidths ="0;1635"
                    ...
                    Begin
                        Begin Label
                            ...
                            Width =1275
                            Height =245
                            Name ="NewSalesGroup_Label"
                            Caption ="NewSalesGroup"
                        End
                    End
                End
                Begin CommandButton
...
End
CodeBehindForm
' See "SalesDepartmentGroupID.cls"

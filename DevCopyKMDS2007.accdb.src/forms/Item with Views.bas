...
Begin Form
    ...
    Filter ="((Item.DaysSupplyGroupID Is Null))"
    ShortcutMenuBar ="KMDSPopup"
    OrderBy ="SubCategoryID, Item.Description, Item.ID"
    RecSrcDt = Begin
        0x52499d700db3e240
    End
    OnDirty ="[Event Procedure]"
    RecordSource ="Item"
    Caption ="Items by Code KMDS Software ©  KMDS Software ©  KMDS Software ©  KMDS Software ©"
        " "
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    Name ="cmbItemByCode"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT dbo_vwItemsByCode.ID, dbo_vwItemsByCode.Description, dbo_vwItemsByCode.De"
                        "scription AS SizeD, dbo_vwItemsByCode.Onhand, dbo_vwItemsByCode.Price, Cost, For"
                        "mat(([price]-[cost])/[price],\"Percent\") AS GP FROM dbo_vwItemsByCode; "
                ...
                Begin ComboBox
                    ...
                    Name ="cmbItemByDesc"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT dbo_vwItemsByDescription.Description, dbo_vwItemsByDescription.Descriptio"
                        "n AS SizeD, dbo_vwItemsByDescription.ID, dbo_vwItemsByDescription.Onhand, dbo_vw"
                        "ItemsByDescription.Price, dbo_vwItemsByDescription.Cost, Format(([price]-[cost])"
                        "/[price],\"Percent\") AS GP FROM dbo_vwItemsByDescription; "
                ...
                Begin ComboBox
                    ...
                    Name ="cmbItemByUPC"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT dbo_vwItemsByUPCCode.UPCCode, dbo_vwItemsByUPCCode.Description, dbo_vwIte"
                        "msByUPCCode.ID, dbo_vwItemsByUPCCode.Onhand, dbo_vwItemsByUPCCode.Price, dbo_vwI"
                        "temsByUPCCode.Cost, Format(([price]-[cost])/[price],\"Percent\") AS GP FROM dbo_"
                        "vwItemsByUPCCode; "
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT dbo_vwItemsByPriceGroup.PriceGroup, dbo_vwItemsByPriceGroup.Description, "
                        "dbo_vwItemsByPriceGroup.Description AS SizeD, dbo_vwItemsByPriceGroup.ID, dbo_vw"
                        "ItemsByPriceGroup.Onhand, dbo_vwItemsByPriceGroup.Price, dbo_vwItemsByPriceGroup"
                        ".Cost, Format(([price]-[cost])/[price],\"Percent\") AS GP FROM dbo_vwItemsByPric"
                        "eGroup; "
                    ColumnWidths ="1440;2880;720;720;720;720;720;360"
                    AfterUpdate ="[Event Procedure]"
                    FontName ="Trebuchet MS"
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT dbo_vwItemsByLocation.Location, dbo_vwItemsByLocation.Description, dbo_vw"
                        "ItemsByLocation.Description AS SizeD, dbo_vwItemsByLocation.ID, dbo_vwItemsByLoc"
                        "ation.Onhand, dbo_vwItemsByLocation.Price, dbo_vwItemsByLocation.Cost, Format((["
                        "price]-[cost])/[price],\"Percent\") AS GP FROM dbo_vwItemsByLocation; "
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT dbo_vwItemsBySubCategory.Category, dbo_vwItemsBySubCategory.Description, "
                        "dbo_vwItemsBySubCategory.SizeD, dbo_vwItemsBySubCategory.ID, dbo_vwItemsBySubCat"
                        "egory.Onhand, dbo_vwItemsBySubCategory.Price, dbo_vwItemsBySubCategory.Cost, For"
                        "mat(([price]-[cost])/[price],\"Percent\") AS GP FROM dbo_vwItemsBySubCategory; "
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT dbo_vwItemsByVendor.Name, dbo_vwItemsByVendor.Description, dbo_vwItemsByV"
                        "endor.SizeD, dbo_vwItemsByVendor.ID, dbo_vwItemsByVendor.Onhand, dbo_vwItemsByVe"
                        "ndor.Price, dbo_vwItemsByVendor.Cost, Format(([price]-[cost])/[price],\"Percent\""
                        ") AS GP, dbo_vwItemsByVendor.StockNumber FROM dbo_vwItemsByVendor; "
                    ColumnWidths ="1440;2880;720;720;720;720;720;360"
                    AfterUpdate ="[Event Procedure]"
                    FontName ="Trebuchet MS"
                ...
                Begin TextBox
                    ...
                    OnDblClick ="[Event Procedure]"
                    ControlTipText ="Double Click to Assign Day's Supply ID"
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT [SalesDepartmentID] & \" - \" & [SD] AS SDp, dbo_vwItemsBySalesDepartment"
                        "ID.SalesDepartmentID AS Dept, dbo_vwItemsBySalesDepartmentID.Description, dbo_vw"
                        "ItemsBySalesDepartmentID.SizeD, dbo_vwItemsBySalesDepartmentID.ID, dbo_vwItemsBy"
                        "SalesDepartmentID.Onhand, dbo_vwItemsBySalesDepartmentID.Price, dbo_vwItemsBySal"
                        "esDepartmentID.Cost, Format(([price]-[cost])/[price],\"Percent\") AS GP FROM dbo"
                        "_vwItemsBySalesDepartmentID; "
                    ColumnWidths ="360;1440;2880;720;720;720;720;720;360"
                    AfterUpdate ="[Event Procedure]"
                    FontName ="Trebuchet MS"
                    UnicodeAccessKey =83

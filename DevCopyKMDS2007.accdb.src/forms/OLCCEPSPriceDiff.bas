        ...
        Begin Section
            ...
            Begin
                Begin Subform
                    ...
                    Width =11040
                    Height =3840
                    Name ="OLCCEPSPriceDiffSub"
                    SourceObject ="Form.OLCCEPSPriceDiffSub"
                    ...
                    Begin
                        Begin Label
                            ...
                            Width =1968
                            Height =300
                            Name ="OLCCEPSPriceDiffSub Label"
                            Caption ="Price Differences "
                            EventProcPrefix ="OLCCEPSPriceDiffSub_Label"
                            LayoutCachedTop =120
                ...
                Begin TextBox
                    ...
                    TabIndex =1
                    Name ="Text1"
                    ControlSource ="=[OLCCEPSPriceDiffSub].[Form]![txtTotalDiff]"
                    Format ="$#,##0.00;($#,##0.00)"

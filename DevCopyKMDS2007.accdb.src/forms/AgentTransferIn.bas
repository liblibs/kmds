            ...
            Begin
                ...
                Begin ListBox
                    ...
                    RowSource ="SELECT Agents.AgentNumber, Agents.LastName AS Name, Agents.FirstName, Agents.Act"
                        "iveForTransfer FROM Agents WHERE (((Agents.LastName) Not Like \"*CLAIM*\") AND ("
                        "(Agents.ActiveForTransfer)<>0)) ORDER BY Agents.AgentNumber; "
                ...
                Begin ListBox
                    ...
                    Name ="lstInvoices"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT AgentTransferHead.ID, [FirstName] & \" \" & [LastName] AS Name, Format([O"
                        "rdDate],\"mm/dd\") AS [Date], AgentTransferHead.Order AS InvNumber, Sum(AgentTra"
                        "nsferLines.QuantityShipped) AS SumOfQuantityShipped, Sum([QuantityShipped]*[Pric"
                        "e]) AS Dollars FROM (Agents INNER JOIN AgentTransferHead ON Agents.AgentNumber=A"
                        "gentTransferHead.AgentID) LEFT JOIN AgentTransferLines ON AgentTransferHead.ID=A"
                        "gentTransferLines.AgentTransferHeadID WHERE (((AgentTransferHead.Status)=\"I\"))"
                        " GROUP BY AgentTransferHead.ID, [FirstName] & \" \" & [LastName], Format([OrdDat"
                        "e],\"mm/dd\"), AgentTransferHead.Order ORDER BY [FirstName] & \" \" & [LastName]"
                        ", Format([OrdDate],\"mm/dd\"); "
                ...
                Begin CommandButton
                    ...
                    TabIndex =11
                    Name ="cmdFTP"
                    Caption ="Check for FTP Transfers"
                    OnClick ="[Event Procedure]"
                ...
                Begin CommandButton
                    ...
                    Begin
                        Begin Label
                            ...
                            Height =600
                            Name ="Label33"
                            Caption ="If you do not see the agent in the yellow list box then click on the button belo"
                                "w. "
                            LayoutCachedLeft =7500
                            LayoutCachedTop =300

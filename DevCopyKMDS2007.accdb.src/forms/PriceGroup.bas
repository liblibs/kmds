...
Begin Form
    ...
    Tag ="62 Price Group List"
    Filter ="((PriceGroup.ID>1))"
    RecSrcDt = Begin
        0x6d92e46f7497e240
    End
    OnDirty ="[Event Procedure]"
    RecordSource ="PriceGroup"
    Caption ="PriceGroup"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT PriceGroup.ID, PriceGroup.Description FROM PriceGroup WHERE (((PriceGroup"
                        ".ID)<>0)) ORDER BY PriceGroup.Description; "
                    ColumnWidths ="0;1440"
                    AfterUpdate ="[Event Procedure]"
                ...
                Begin Subform
                    ...
                    TabIndex =3
                    Name ="PriceGoupSub"
                    SourceObject ="Form.PriceGroupSub"
                    LinkChildFields ="PriceGroupID"
                    LinkMasterFields ="ID"

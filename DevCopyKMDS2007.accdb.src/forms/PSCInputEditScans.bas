        ...
        Begin Section
            ...
            Begin
                Begin Subform
                    ...
                    Height =4620
                    Name ="PSCInput"
                    SourceObject ="Form.PSCInputEditScansSub"
        ...
        Begin FormFooter
            ...
            Begin
                Begin CommandButton
                    ...
                    Width =1206
                    Height =1026
                    Name ="cmdSetupNotOnFile"
                    Caption ="Setup Not On File"
                ...
                Begin CommandButton
                    ...
                    Height =405
                    TabIndex =1
                    Name ="cmdClubOrderCreate"
                    Caption ="&Club Order Create"
                    OnClick ="[Event Procedure]"
                    UnicodeAccessKey =67
                    ...
                    Begin
                        Begin Label
                            ...
                            Height =630
                            Name ="Label5"
                            Caption ="If you choose \"Club Order Create\" and the quantity is -1 then the quantity ord"
                                "ered will become 1."
                        End
                    End
                End
                Begin CommandButton
                    ...
                    TabIndex =2
                    Name ="cmdAudit"
                    Caption ="Audit Inventory Create"
                    OnClick ="[Event Procedure]"
                    ...
                    Begin
                        Begin Label
                            ...
                            Height =825
                            Name ="Label6"
                            Caption ="If you choose \"Audit Inventory Create\" and the quantity is -1 then the Physica"
                                "l Count will become the 'on shelf' amount.1."
                        End
                    End
                End
                Begin Label
                    ...
                    Height =420
                    Name ="Label4"
                    Caption ="This screen allows you to view/change the data before going on to the next step."
                End
                Begin CommandButton
                    OverlapFlags =85
                    Left =13440
